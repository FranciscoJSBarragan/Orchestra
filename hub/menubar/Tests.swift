...
enum OrchestraTasksTests {
    static func main() async throws {
        ...
        let observationPayload = #"{"id":"task-1","short_id":"A1","label":"Wrong title","preparation_status":"active","disposition":"open","stage":"review","status":"active","summary":"Review 1","updated_at":"2026-08-12T10:05:00Z","stop_requested_at":"wrong","capabilities":{"purge":true}}"#.data(using: .utf8)!
