...
The root owns PR intent synthesis. Require explicit repository, base, head, title, human body, exact revision, approved objective, acceptance, invariants, validation, and known risks.
