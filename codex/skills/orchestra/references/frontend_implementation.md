...
Use this internal playbook only with the `implementation_worker` profile and the explicit `frontend_implementation` capability. Frontend work is at least standard tier.
