...
- Require `browser_route: auto | in_app | chrome`. An explicit user route, relayed by the root or supplied directly in the agent conversation, remains fixed unless that instruction also authorizes fallback.
