...
5. Remove the task worktree and its root-owned local plan only after verified integration and only while both worktrees remain clean. Delete the task branch only after Git proves it fully merged.
